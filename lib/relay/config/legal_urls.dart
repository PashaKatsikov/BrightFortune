...
const String homeLink = 'https://brighttfortune.site'; // [FORGE]
const String privacyLink = 'https://brighttfortune.site/privacy-policy.html'; // [FORGE]
const String supportLink = 'https://brighttfortune.site/support.html'; // [FORGE]
