...
abstract final class RelayConfig {
  ...
  static const String applicationId = 'com.brightfortune.brightfortunegame'; // [FORGE]
  static const String marketId = 'com.brightfortune.brightfortunegame'; // [FORGE]
  static const String displayName = 'Bright Fortune'; // [FORGE]
  ...
  /// Range: 4..12 seconds.
  static const int organicRescueDelay = 5;

  /// Verdict POST timeout. Range: 10..25 seconds.
  static const int verdictTimeoutSeconds = 24;

  /// Awaiting install-conversion payload on a first launch.
  /// Range: 20..40 seconds.
  static const int firstInstallAwaitSeconds = 38;

  /// Awaiting install-conversion payload on a returning launch.
  /// Range: 3..10 seconds.
  static const int returningInstallAwaitSeconds = 10;

  /// Deep-link callback wait. Range: 3..8 seconds.
  static const int deepLinkAwaitSeconds = 8;
  ...
  static const int pushLaunchAwaitSeconds = 4;
  ...
  static const int reachDropDebounceMs = 540;
  ...
  static const int cachedUrlLifetimeSeconds = 900000;
